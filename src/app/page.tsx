          ...
          <div className="mb-12 max-w-lg mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-10 py-5 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl text-white text-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 font-medium tracking-wide"
              />
